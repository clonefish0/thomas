...
const h2Style = {
    color: "rgba(247,180,180,0.85)",
    fontFamily: "var(--font-mono)",
    letterSpacing: "0.04em",
} as const;

const h3Style = {
    color: "rgba(234,200,200,0.9)",
} as const;

const divider = (
    <div className="h-px my-8" style={{ background: "rgba(247,180,180,0.07)" }} />
);
...
function DataBox({ items }: { items: { label: string; value: string }[] }) {
    return (
        <div
            ...
            style={{ background: "rgba(247,180,180,0.04)", border: "1px solid rgba(247,180,180,0.08)" }}
        >
            {items.map(({ label, value }) => (
                <div key={label}>
                    <span style={metaLabel}>{label}:</span>{" "}
                    <span style={{ color: "rgba(234,200,200,0.6)" }}>{value}</span>
                </div>
            ))}
        </div>
    );
        ...
        <div className="relative min-h-screen px-6 py-20" style={{ backgroundColor: "transparent", zIndex: 1 }}>
            <div className="max-w-2xl mx-auto">
                ...
                <Link
                    ...
                    style={{ color: "rgba(247,180,180,0.5)" }}
                >
                    ← Zurück
                </Link>
                ...
                <p className="text-sm mb-12" style={{ color: "rgba(247,180,180,0.4)", fontFamily: "var(--font-mono)" }}>
                ...
                <p
                    ...
                    style={{ ...metaLabel, color: "rgba(247,180,180,0.6)", fontSize: "0.65rem" }}
                >
                    Teil I
                </p>
                ...
                <div className="space-y-10 text-sm leading-relaxed" style={{ color: "rgba(234,200,200,0.65)" }}>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            40721 Hilden<br /><br />
                            E-Mail:{" "}
                            <a href="mailto:thomas@cbta-coaching.de" style={{ color: "rgba(247,180,180,0.7)" }}>
                                thomas@cbta-coaching.de
                            </a><br />
                            Telefon:{" "}
                            <a href="tel:+4917632692381" style={{ color: "rgba(247,180,180,0.7)" }}>
                                017632692381
                            </a><br />
                            Impressum:{" "}
                            <a href="/impressum" style={{ color: "rgba(247,180,180,0.7)" }}>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-3 mb-4">
                            <li>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO)</strong> – Die betroffene Person hat ihre
                            ...
                            <li>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO)</strong> – Die
                            ...
                            <li>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO)</strong> – Die Verarbeitung ist zur
                                Erfüllung einer rechtlichen Verpflichtung erforderlich, der der Verantwortliche unterliegt.
                            </li>
                            <li>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</strong> – Die Verarbeitung ist zur
                        ...
                        <p>
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Nationale Datenschutzregelungen in Deutschland:</strong> Zusätzlich zu den Datenschutzregelungen
                    ...
                    <section>
                        ...
                        <p>
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>TLS-/SSL-Verschlüsselung (HTTPS):</strong> Um die Daten der Nutzer vor unerlaubten Zugriffen zu
                    ...
                    <section>
                        ...
                        <p className="mb-3">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Datenverarbeitung in Drittländern:</strong> Sofern wir Daten in ein Drittland (d. h. außerhalb der
                        ...
                        <p>
                            ...
                            <a href="https://www.dataprivacyframework.gov/" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2">
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>10 Jahre</strong> – Bücher und Aufzeichnungen, Jahresabschlüsse, Inventare, Lageberichte (§ 147 Abs. 1 Nr. 1 AO, § 257 Abs. 1 Nr. 1 HGB)</li>
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>8 Jahre</strong> – Buchungsbelege, z. B. Rechnungen und Kostenbelege (§ 147 Abs. 1 Nr. 4 AO, § 257 Abs. 1 Nr. 4 HGB)</li>
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>6 Jahre</strong> – Übrige Geschäftsunterlagen: empfangene Handels- und Geschäftsbriefe, sonstige Unterlagen (§ 147 Abs. 1 Nr. 2, 3, 5 AO, § 257 Abs. 1 Nr. 2 u. 3 HGB)</li>
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>3 Jahre</strong> – Daten für potenzielle Gewährleistungs- und Schadensersatzansprüche, basierend auf der regulären gesetzlichen Verjährungsfrist (§§ 195, 199 BGB)</li>
                        </ul>
                    </section>
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={title} className="list-none">
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>{title}:</strong>{" "}
                                    {desc}
                                </li>
                            ))}
                        </ul>
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Onlineshop und E-Commerce:</strong> Wir verarbeiten die Daten unserer Kunden, um ihnen die
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Bildungs- und Schulungsleistungen:</strong> Wir verarbeiten die Daten der Teilnehmer unserer
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Webhosting (gemieteter Speicherplatz):</strong> Für die Bereitstellung unseres Onlineangebotes
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Zugriffsdaten und Logfiles:</strong> Der Zugriff auf unser Onlineangebot wird in Form von
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Vercel (Hosting):</strong> Wir nutzen Vercel für das Hosting unseres Onlineangebotes. Vercel ist
                                ...
                                <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>
                                    vercel.com
                                </a>; Datenschutzerklärung:{" "}
                                <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>
                    ...
                    <section>
                        ...
                        <p className="mb-3">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Speicherdauer:</strong>
                        </p>
                        <ul className="list-disc list-inside space-y-2 mb-4">
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>Temporäre Cookies (Session-Cookies):</strong> Werden spätestens gelöscht, nachdem ein Nutzer das Onlineangebot verlassen und sein Endgerät geschlossen hat.</li>
                            <li><strong style={{ color: "rgba(234,200,200,0.8)" }}>Permanente Cookies:</strong> Bleiben auch nach dem Schließen des Endgeräts gespeichert. Die Speicherdauer kann bis zu zwei Jahre betragen.</li>
                        </ul>
                        <p className="mb-4">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Widerruf und Widerspruch (Opt-out):</strong> Nutzer können die von ihnen abgegebenen
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Löschung nach Kündigung:</strong> Wenn Nutzer ihr Nutzerkonto gekündigt haben, werden deren Daten
                    ...
                    <section>
                        ...
                        <p>
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Kommentare und Beiträge:</strong> Wenn Nutzer Kommentare oder sonstige Beiträge hinterlassen,
                    ...
                    <section>
                        ...
                        <p className="mt-4">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Kontaktformular:</strong> Bei Kontaktaufnahme über unser Kontaktformular, per E-Mail oder anderen
                    ...
                    <section>
                        ...
                        <div className="mt-4">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Google Analytics:</strong> Wir verwenden Google Analytics zur Messung und Analyse der Nutzung
                                ...
                                <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>
                                    policies.google.com/privacy
                                </a>; Grundlage Drittlandtransfers: Data Privacy Framework (DPF); Opt-Out:{" "}
                                <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Instagram:</strong> Soziales Netzwerk, ermöglicht das Teilen von Fotos und Videos;
                                Dienstanbieter: Meta Platforms Ireland Limited, Merrion Road, Dublin 4, Irland; Website:{" "}
                                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>instagram.com</a>;
                                Datenschutzerklärung:{" "}
                                <a href="https://privacycenter.instagram.com/policy/" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>privacycenter.instagram.com/policy/</a>;
                                Grundlage Drittlandtransfers: Data Privacy Framework (DPF).
                            </p>
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>YouTube:</strong> Soziales Netzwerk und Videoplattform;
                                Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland;
                                Datenschutzerklärung:{" "}
                                <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>policies.google.com/privacy</a>;
                                Grundlage Drittlandtransfers: Data Privacy Framework (DPF);
                                Opt-Out:{" "}
                                <a href="https://myadcenter.google.com/personalizationoff" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>myadcenter.google.com/personalizationoff</a>.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Instagram-Plugins und -Inhalte:</strong> Instagram Plugins und -Inhalte – hierzu können z. B.
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>YouTube-Videos:</strong> Videoinhalte; Dienstanbieter: Google Ireland Limited, Gordon House,
                                Barrow Street, Dublin 4, Irland; Rechtsgrundlage: Art. 6 Abs. 1 S. 1 lit. a) DSGVO
                                (Einwilligung); Website:{" "}
                                <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>youtube.com</a>;
                                Datenschutzerklärung:{" "}
                                <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(247,180,180,0.7)" }}>policies.google.com/privacy</a>;
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>YouTube-Videos (erweiterter Datenschutzmodus):</strong> Die Integration von YouTube-Videos
                    ...
                    <section>
                        ...
                        <p className="mb-3">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Rechtsgrundlagen (Deutschland):</strong> Soweit wir Daten zur Erfüllung unserer gesetzlichen
                        ...
                        <p className="mb-3">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Angabe von Namen:</strong> Sie haben die Möglichkeit, Hinweise anonym abzugeben. Sofern es nicht
                        ...
                        <p className="mb-4">
                            <strong style={{ color: "rgba(234,200,200,0.85)" }}>Bereitstellung von Daten an Dritte:</strong> Daten, die im Zusammenhang mit den abgegebenen
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={term}>
                                    <dt className="font-medium mb-1" style={{ color: "rgba(234,200,200,0.85)", fontFamily: "var(--font-mono)", fontSize: "0.75rem" }}>
                                        {term}
                                    </dt>
                    ...
                    <div className="h-px my-12" style={{ background: "rgba(247,180,180,0.15)" }} />
                    ...
                    <div className="pt-4">
                        ...
                        <p className="text-sm mb-10" style={{ color: "rgba(247,180,180,0.4)", fontFamily: "var(--font-mono)" }}>
                    ...
                    <div className="space-y-8">
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-2 mb-3">
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Online-Personal-Training:</strong> Erstellung individueller Trainingspläne, angepasst an Ihre
                                    persönlichen Fitnessziele und körperlichen Voraussetzungen.
                                </li>
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Online-Ernährungscoaching:</strong> Erstellung von personalisierten Ernährungsplänen und Beratung
                                    basierend auf Ihren Ernährungsbedürfnissen.
                                </li>
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Online-Lifestyle-Coaching:</strong> Beratung zur Anpassung des Lebensstils zur Steigerung des
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-3">
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Gesundheitsangaben:</strong> Sie müssen mich vor Beginn umfassend über Ihren aktuellen
                                    Gesundheitszustand, Verletzungen und Vorerkrankungen informieren.
                                </li>
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Eigenverantwortung & Stopp-Signal:</strong> Sie setzen die Pläne eigenverantwortlich um. Bei
                                ...
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Kommunikation:</strong> Eine regelmäßige Kommunikation (Check-ins) ist für den Erfolg
                        ...
                        <section>
                            ...
                            <p>
                                <strong style={{ color: "rgba(234,200,200,0.85)" }}>Hinweis:</strong> Bei digitalen Dienstleistungen kann das Widerrufsrecht vorzeitig erlöschen,
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-3">
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Feste Laufzeit:</strong> Verträge mit einer vereinbarten Mindestlaufzeit (z. B. 6 Monate) können
                                ...
                                <li>
                                    <strong style={{ color: "rgba(234,200,200,0.85)" }}>Abo-Modelle:</strong> Sofern ein monatlich kündbares Abo vereinbart wurde, bedarf die Kündigung
                    ...
                    {/* Footer nav */}
                    <div className="h-px mt-16 mb-8" style={{ background: "rgba(247,180,180,0.07)" }} />
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between text-xs" style={{ color: "rgba(234,200,200,0.35)" }}>
                        <span style={{ fontFamily: "var(--font-mono)" }}>cbta – Coaching by Thomas Arndt</span>
                        <Link href="/impressum" style={{ color: "rgba(247,180,180,0.5)" }}>→ Impressum</Link>
                    </div>
                </div>
            </div>
        </div>
