...
function SectionLabel({ children }: { children: React.ReactNode }) {
    return (
        <p
            ...
            style={{ color: "rgba(247,180,180,0.5)", fontFamily: "var(--font-mono)" }}
        >
            {children}
        </p>
    );
...
function Divider() {
    return (
        <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, rgba(247,180,180,0.08), transparent)" }}
        />
    );
}
                ...
                >
                    {problems.map((p) => (
                        <motion.div
                            ...
                            style={{
                                background: "rgba(247,180,180,0.04)",
                                border: "1px solid rgba(247,180,180,0.08)",
                            }}
                        >
                            <span
                                className="text-xs font-mono tracking-widest mb-4 block"
                                style={{ color: "rgba(247,180,180,0.35)" }}
                            >
                                {p.number}
                            </span>
                            <h3
                            ...
                            <p
                                ...
                                style={{ color: "rgba(234,200,200,0.65)" }}
                            >
                                {p.text}
                            </p>
                        </motion.div>
                        ...
                        {[
                            ...
                            <motion.div
                                ...
                                style={{
                                    ...
                                    border: "1px solid rgba(247,180,180,0.1)",
                                }}
                            >
                                <h4
                                    className="text-base font-semibold mb-2"
                                    style={{ color: "rgba(247,180,180,0.9)", fontFamily: "var(--font-mono)" }}
                                >
                                    {item.label}
                                </h4>
                                <p
                                    className="text-sm leading-relaxed"
                                    style={{ color: "rgba(234,200,200,0.6)" }}
                                >
                                    {item.text}
                                </p>
                            </motion.div>
                    ...
                    {benefits.map((b, i) => (
                        ...
                        >
                            <div
                                ...
                                style={{
                                    background: `linear-gradient(90deg, transparent, rgba(247,180,180,${0.2 + i * 0.1}), transparent)`,
                                }}
                            />
                            <h3
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(50% 80% at 50% 100%, rgba(190,45,45,0.1) 0%, transparent 70%)",
                }}
            />
            <div className="relative max-w-3xl mx-auto pt-20 text-center">
                ...
                >
                    ...
                    >
                        <motion.div variants={fadeUp} className="grid sm:grid-cols-2 gap-4">
                            <input
                                ...
                                style={{
                                    background: "rgba(247,180,180,0.05)",
                                    border: "1px solid rgba(247,180,180,0.12)",
                                    color: "#ffffff",
                                }}
                                onFocus={(e) => (e.currentTarget.style.borderColor = "rgba(247,180,180,0.35)")}
                                onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(247,180,180,0.12)")}
                            />
                            <input
                                name="email"
                                type="email"
                    ...
                    <motion.p
                        variants={fadeUp}
                        className="text-sm"
                        style={{ color: "rgba(234,200,200,0.35)" }}
                    >
                        Oder direkt:{" "}
                        <a
                            href="mailto:thomas@cbta-coaching.de"
                            style={{ color: "rgba(247,180,180,0.6)" }}
                        >
