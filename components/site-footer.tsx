...
export function SiteFooter() {
    return (
        <footer
            ...
            style={{ borderTop: "1px solid rgba(247,180,180,0.07)" }}
        >
            <style>{`
                .footer-social { color: rgba(234,200,200,0.35); transition: color 0.2s; }
                .footer-social:hover { color: rgba(247,180,180,0.8); }
                .footer-link { color: rgba(234,200,200,0.35); transition: color 0.2s; }
                .footer-link:hover { color: rgba(247,180,180,0.7); }
            `}</style>
            <div className="max-w-5xl mx-auto">
                ...
                <div
                    ...
                    style={{ borderTop: "1px solid rgba(247,180,180,0.06)" }}
                >
